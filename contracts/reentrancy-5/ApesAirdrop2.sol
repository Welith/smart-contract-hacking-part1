...
// Challenge created by: Pawel Haldrzynski https://twitter.com/phaldrzynski
...
/**
 * @title ApesAirdrop2
 * @author JohnnyTime (https://smartcontractshacking.com) and slightly modified by https://twitter.com/phaldrzynski
 * @notice ApesAirdrop inherits from ReentrancyGuard and function mint() is nonReentrant
 */
contract ApesAirdrop2 is ERC721, ReentrancyGuard {
    ...
    constructor() ERC721("Crazy Apes Much More Secure", "APE") {
        owner = msg.sender;
