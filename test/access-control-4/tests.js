...
describe("Access Control Exercise 4", function () {
  ...
  before(async function () {
    ...
    await this.starlight
      .connect(user1)
      .buyTokens(USER1_PURCHASE.mul(100), user1.address, {
        value: USER1_PURCHASE,
      });
    await this.starlight
      .connect(user2)
      .buyTokens(USER2_PURCHASE.mul(100), user2.address, {
        value: USER2_PURCHASE,
      });
    await this.starlight
      .connect(user3)
      .buyTokens(USER3_PURCHASE.mul(100), user3.address, {
